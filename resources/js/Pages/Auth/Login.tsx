...
export default function Login() {
    ...
    return (
        <>
            ...
            <main className="min-h-screen w-full flex select-none antialiased bg-slate-50 dark:bg-[#1a1c1c] text-slate-800 dark:text-slate-100 transition-colors duration-300" style={{ fontFamily: "'Inter', sans-serif" }}>
                ...
                <section className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 bg-white dark:bg-[#2b2d2d] border-l border-slate-100 dark:border-[#414343] transition-colors duration-300">
                    <div className="w-full max-w-[440px] flex flex-col gap-6">
                        ...
                        <div className="flex flex-col items-center lg:items-start gap-2">
                            ...
                            />
                            <span className="text-3xl font-bold tracking-tighter text-rose-700 dark:text-rose-500" style={{ fontFamily: "'Outfit', sans-serif" }}>
                                MARIDONOR
                            </span>
                        </div>
                        ...
                        <form className="flex flex-col gap-4" onSubmit={submit}>
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-bold text-slate-500 dark:text-slate-400 ml-1" htmlFor="email">
                                    Email
                                </label>
                                <div className="relative group">
                                    ...
                                    <input 
                                        className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-[#414343] border border-slate-200 dark:border-transparent rounded-xl input-transition outline-none focus:border-rose-600 focus:bg-white dark:focus:bg-[#4d4f4f] text-sm text-slate-800 dark:text-white" 
                                        id="email" 
                                        type="email"
                                        value={data.email}
                                ...
                                {errors.email && (
                                    <p className="text-xs text-red-650 font-semibold pl-1">{errors.email}</p>
                                )}
                            </div>

                            <div className="flex flex-col gap-1.5">
                                <div className="flex justify-between items-center px-1">
                                    <label className="text-xs font-bold text-slate-500 dark:text-slate-400" htmlFor="password">
                                        Password
                                    </label>
                                    <Link className="text-xs font-semibold text-rose-600 dark:text-rose-500 hover:underline transition-all" href="#">
                                        Lupa Password?
                                    </Link>
                                </div>
                                <div className="relative group">
                                    ...
                                    <input 
                                        className="w-full pl-12 pr-12 py-3.5 bg-slate-50 dark:bg-[#414343] border border-slate-200 dark:border-transparent rounded-xl input-transition outline-none focus:border-rose-600 focus:bg-white dark:focus:bg-[#4d4f4f] text-sm text-slate-800 dark:text-white" 
                                        id="password" 
                                ...
                                {errors.password && (
                                    <p className="text-xs text-red-650 font-semibold pl-1">{errors.password}</p>
                                )}
                            </div>
                            ...
                            <div className="flex items-center gap-2 px-1 py-1">
                                ...
                                />
                                <label className="text-xs text-slate-500 dark:text-slate-400 cursor-pointer select-none" htmlFor="remember">
                        ...
                        <div className="relative flex items-center py-1">
                            <div className="flex-grow border-t border-slate-100 dark:border-[#414343]"></div>
                        ...
                        <div className="text-center">
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                Belum punya akun?{' '}
                                <Link className="text-rose-600 dark:text-rose-500 font-bold hover:underline" href="/register">
                        ...
                        {/* Institutional Entry */}
                        <div className="mt-2 p-4 bg-slate-50 dark:bg-[#414343]/30 border border-slate-100 dark:border-[#414343]/50 rounded-2xl flex flex-col gap-3">
                            <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 tracking-wider text-center uppercase">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button 
                                    ...
                                    className="flex items-center justify-center gap-2 py-2.5 px-4 bg-white dark:bg-[#414343] border border-slate-200 dark:border-transparent rounded-xl hover:bg-slate-100 dark:hover:bg-[#4d4f4f] transition-all text-slate-600 dark:text-slate-300 text-xs font-bold shadow-sm"
                                >
                        ...
                        {/* Footer Links */}
                        <footer className="mt-8 pt-4 flex justify-center gap-6 border-t border-slate-100 dark:border-[#414343]">
